<template>
  <div id="flowIntr">
    <ul class="clear">
      ...
      <li class="item">
        <p class="num">Item No.</p>
        <h2 class="number">01</h2>
        <p class="title">沟通评估</p>
        <p class="eng">
          ONE-STOP SERVICE ENTERPRISE<br>
          LIFE CYCLE
        </p>
